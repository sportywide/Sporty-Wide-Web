module.exports = /******/ (function(modules) {
  ...
  \*********************/
			...
			/***/ function(module, exports, __webpack_require__) {
				'use strict';
				eval(
					"\n\nObject.defineProperty(exports, \"__esModule\", {\n  value: true\n});\nexports.Gulpfile = void 0;\n\nvar _gulpclass = __webpack_require__(/*! gulpclass */ \"gulpclass\");\n\nvar _gulp = _interopRequireDefault(__webpack_require__(/*! gulp */ \"gulp\"));\n\nvar _process = __webpack_require__(/*! @root/helpers/process */ \"./helpers/process.ts\");\n\nvar _dec, _dec2, _dec3, _dec4, _dec5, _dec6, _dec7, _dec8, _dec9, _dec10, _dec11, _dec12, _dec13, _dec14, _dec15, _dec16, _dec17, _dec18, _dec19, _dec20, _dec21, _dec22, _dec23, _class, _class2;\n\nfunction _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }\n\nfunction _applyDecoratedDescriptor(target, property, decorators, descriptor, context) { var desc = {}; Object.keys(descriptor).forEach(function (key) { desc[key] = descriptor[key]; }); desc.enumerable = !!desc.enumerable; desc.configurable = !!desc.configurable; if ('value' in desc || desc.initializer) { desc.writable = true; } desc = decorators.slice().reverse().reduce(function (desc, decorator) { return decorator(target, property, desc) || desc; }, desc); if (context && desc.initializer !== void 0) { desc.value = desc.initializer ? desc.initializer.call(context) : void 0; desc.initializer = undefined; } if (desc.initializer === void 0) { Object.defineProperty(target, property, desc); desc = null; } return desc; }\n\n__webpack_require__(/*! reflect-metadata */ \"reflect-metadata\");\n\n__webpack_require__(/*! tsconfig-paths/register */ \"tsconfig-paths/register\");\n\nconst argv = __webpack_require__(/*! yargs */ \"yargs\").argv;\n\nlet Gulpfile = (_dec = (0, _gulpclass.Gulpclass)(), _dec2 = (0, _gulpclass.Task)('bootstrap'), _dec3 = Reflect.metadata(\"design:paramtypes\", []), _dec4 = (0, _gulpclass.Task)('cz'), _dec5 = Reflect.metadata(\"design:paramtypes\", []), _dec6 = (0, _gulpclass.Task)('eslint'), _dec7 = Reflect.metadata(\"design:paramtypes\", []), _dec8 = (0, _gulpclass.Task)('tsc'), _dec9 = Reflect.metadata(\"design:paramtypes\", []), _dec10 = (0, _gulpclass.SequenceTask)('lint'), _dec11 = Reflect.metadata(\"design:paramtypes\", []), _dec12 = (0, _gulpclass.Task)('dev:exec'), _dec13 = Reflect.metadata(\"design:paramtypes\", []), _dec14 = (0, _gulpclass.Task)('generate:migration'), _dec15 = Reflect.metadata(\"design:paramtypes\", []), _dec16 = (0, _gulpclass.Task)('test'), _dec17 = Reflect.metadata(\"design:paramtypes\", []), _dec18 = (0, _gulpclass.Task)('test:api'), _dec19 = Reflect.metadata(\"design:paramtypes\", []), _dec20 = (0, _gulpclass.Task)('typecheck'), _dec21 = Reflect.metadata(\"design:paramtypes\", []), _dec22 = (0, _gulpclass.Task)('ci:validate'), _dec23 = Reflect.metadata(\"design:paramtypes\", []), _dec(_class = (_class2 = class Gulpfile {\n  /** Generic tasks **/\n  bootstrap() {\n    if (argv.ci) {\n      return (0, _process.spawn)('npx lerna bootstrap -- --ci --no-optional && link-parent-bin');\n    } else if (argv.production) {\n      return (0, _process.spawn)('npx lerna bootstrap -- --production --no-optional && link-parent-bin -s true -d false -o false');\n    } else if (argv.packageLockOnly) {\n      return (0, _process.spawn)('npx lerna bootstrap -- --no-optional --package-lock-only');\n    } else if (argv.optional) {\n      return (0, _process.spawn)('npx lerna bootstrap && link-parent-bin');\n    } else {\n      return (0, _process.spawn)('npx lerna bootstrap -- --no-optional && link-parent-bin');\n    }\n  }\n\n  commit() {\n    return (0, _process.spawn)('git add . && git-cz');\n  }\n\n  eslint() {\n    return (0, _process.spawn)(\"eslint '**/*.{js,jsx,ts,tsx}'\");\n  }\n\n  tsCheck() {\n    return (0, _process.spawn)('node --max-old-space-size=4096 node_modules/.bin/tsc --noEmit');\n  }\n\n  lint() {\n    return [_gulp.default.parallel(['tsc', 'eslint'])];\n  }\n\n  exec() {\n    return (0, _process.spawn)(`npx lerna exec \"gulp dev:exec --entry ${argv.entry}\" --stream --scope ${argv.scope}`);\n  }\n\n  generateMigration() {\n    return (0, _process.spawn)('npx ts-node -T bin/migration.ts');\n  }\n  /** Test tasks **/\n\n\n  test() {\n    const args = ['--runInBand'];\n\n    if (argv.watch) {\n      args.push('--watch');\n    }\n\n    if (argv.coverage) {\n      args.push('--coverage');\n    }\n\n    if (argv.it) {\n      args.push('--testRegex=\\\\.it-spec\\\\.ts$');\n      args.push('--detectOpenHandles');\n    }\n\n    if (argv.e2e) {\n      args.push('--testRegex=\\\\.e2e-spec\\\\.ts$');\n    }\n\n    if (argv.full) {\n      args.push('--testRegex=\\\\.it-spec\\\\.tsx?$');\n      args.push('--testRegex=\\\\.e2e-spec\\\\.tsx?$');\n      args.push('--testRegex=\\\\.spec\\\\.tsx?$');\n      args.push('--detectOpenHandles');\n    }\n\n    for (const key of Object.keys(argv)) {\n      if (['watch', 'coverage', 'it', 'e2e', 'full', '$0', '_'].includes(key)) {\n        continue;\n      }\n\n      args.push(`--${key}`);\n\n      if (typeof argv[key] !== 'boolean') {\n        args.push(`\"${argv[key]}\"`);\n      }\n    }\n\n    return (0, _process.spawn)(`npx jest ${args.join(' ')}`);\n  }\n\n  apiTest() {\n    return (0, _process.spawn)('npx ts-node e2e/api/api-test.ts');\n  }\n\n  typeCheck() {\n    return (0, _process.spawn)('node --max-old-space-size=4096 node_modules/.bin/tsc --noEmit');\n  }\n  /** CI tasks **/\n\n\n  validateCi() {\n    return (0, _process.spawn)('cat .gitlab-ci.yml | curl --header \"Content-Type: application/json\" https://gitlab.com/api/v4/ci/lint --data @-');\n  }\n\n}, (_applyDecoratedDescriptor(_class2.prototype, \"bootstrap\", [_dec2, _dec3], Object.getOwnPropertyDescriptor(_class2.prototype, \"bootstrap\"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, \"commit\", [_dec4, _dec5], Object.getOwnPropertyDescriptor(_class2.prototype, \"commit\"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, \"eslint\", [_dec6, _dec7], Object.getOwnPropertyDescriptor(_class2.prototype, \"eslint\"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, \"tsCheck\", [_dec8, _dec9], Object.getOwnPropertyDescriptor(_class2.prototype, \"tsCheck\"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, \"lint\", [_dec10, _dec11], Object.getOwnPropertyDescriptor(_class2.prototype, \"lint\"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, \"exec\", [_dec12, _dec13], Object.getOwnPropertyDescriptor(_class2.prototype, \"exec\"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, \"generateMigration\", [_dec14, _dec15], Object.getOwnPropertyDescriptor(_class2.prototype, \"generateMigration\"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, \"test\", [_dec16, _dec17], Object.getOwnPropertyDescriptor(_class2.prototype, \"test\"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, \"apiTest\", [_dec18, _dec19], Object.getOwnPropertyDescriptor(_class2.prototype, \"apiTest\"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, \"typeCheck\", [_dec20, _dec21], Object.getOwnPropertyDescriptor(_class2.prototype, \"typeCheck\"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, \"validateCi\", [_dec22, _dec23], Object.getOwnPropertyDescriptor(_class2.prototype, \"validateCi\"), _class2.prototype)), _class2)) || _class);\nexports.Gulpfile = Gulpfile;\n\n//# sourceURL=webpack:///./gulpfile.ts?"
				);
