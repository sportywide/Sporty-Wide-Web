module.exports = /******/ (function(modules) {
	...
	/******/
	/******/
	/******/ /******/ return __webpack_require__((__webpack_require__.s = './packages/sw-data/gulpfile.ts'));
	/******/
})(
	/************************************************************************/
	/******/ {
  ...
  \**************************************/
			...
			/***/ function(module, exports, __webpack_require__) {
				'use strict';
				eval(
					'\n\nObject.defineProperty(exports, "__esModule", {\n  value: true\n});\nexports.Gulpfile = void 0;\n\nvar _gulpclass = __webpack_require__(/*! gulpclass */ "gulpclass");\n\nvar _process = __webpack_require__(/*! @root/helpers/process */ "./helpers/process.ts");\n\nvar _gulp = __webpack_require__(/*! @root/helpers/gulp */ "./helpers/gulp.ts");\n\nvar _dec, _dec2, _dec3, _dec4, _dec5, _dec6, _dec7, _class, _class2;\n\nfunction _applyDecoratedDescriptor(target, property, decorators, descriptor, context) { var desc = {}; Object.keys(descriptor).forEach(function (key) { desc[key] = descriptor[key]; }); desc.enumerable = !!desc.enumerable; desc.configurable = !!desc.configurable; if (\'value\' in desc || desc.initializer) { desc.writable = true; } desc = decorators.slice().reverse().reduce(function (desc, decorator) { return decorator(target, property, desc) || desc; }, desc); if (context && desc.initializer !== void 0) { desc.value = desc.initializer ? desc.initializer.call(context) : void 0; desc.initializer = undefined; } if (desc.initializer === void 0) { Object.defineProperty(target, property, desc); desc = null; } return desc; }\n\n__webpack_require__(/*! reflect-metadata */ "reflect-metadata");\n\n__webpack_require__(/*! tsconfig-paths/register */ "tsconfig-paths/register");\n\nconst argv = __webpack_require__(/*! yargs */ "yargs").argv;\n\nlet Gulpfile = (_dec = (0, _gulpclass.Gulpclass)(), _dec2 = (0, _gulpclass.SequenceTask)(\'dev:exec\'), _dec3 = Reflect.metadata("design:paramtypes", []), _dec4 = (0, _gulpclass.SequenceTask)(\'build\'), _dec5 = Reflect.metadata("design:paramtypes", []), _dec6 = (0, _gulpclass.SequenceTask)(\'exec\'), _dec7 = Reflect.metadata("design:paramtypes", []), _dec(_class = (_class2 = class Gulpfile extends _gulp.GenericWebpackTasks {\n  /** Dev tasks **/\n  dev() {\n    process.env.SCRIPT = argv.entry;\n    return [\'dev:webpack\', \'exec\'];\n  }\n  /** Build tasks **/\n\n\n  build() {\n    return [\'clean\', \'build:webpack\'];\n  }\n\n  exec() {\n    return (0, _process.spawn)(`cd dist && TZ=\'UTC\' node ${argv.entry}`);\n  }\n\n}, (_applyDecoratedDescriptor(_class2.prototype, "dev", [_dec2, _dec3], Object.getOwnPropertyDescriptor(_class2.prototype, "dev"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "build", [_dec4, _dec5], Object.getOwnPropertyDescriptor(_class2.prototype, "build"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "exec", [_dec6, _dec7], Object.getOwnPropertyDescriptor(_class2.prototype, "exec"), _class2.prototype)), _class2)) || _class);\nexports.Gulpfile = Gulpfile;\n\n//# sourceURL=webpack:///./packages/sw-data/gulpfile.ts?'
				);
