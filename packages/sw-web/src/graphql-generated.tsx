...
export type GetTeamsQuery = { __typename?: 'Query' } & {
	teams: { __typename?: 'TeamPaginationResult' } & Pick<TeamPaginationResult, 'count'> & {
			items: Array<
				{ __typename?: 'TeamDto' } & Pick<
					TeamDto,
					'id' | 'name' | 'title' | 'ovr' | 'rating' | 'att' | 'def' | 'mid' | 'image' | 'league' | 'leagueId'
				>
			>;
		};
};
...
export type GetUsersQuery = { __typename?: 'Query' } & {
	users: Array<{ __typename?: 'UserDto' } & Pick<UserDto, 'id' | 'firstName' | 'lastName' | 'email'>>;
};
