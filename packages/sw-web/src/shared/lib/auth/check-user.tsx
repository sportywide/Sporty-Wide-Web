...
export const allowPendingSocialOnly = user => user && user.socialProvider && user.status === UserStatus.PENDING;
export const allowPendingOnly = user => user.status === UserStatus.PENDING;
