...
docker run sportywide/sportywide-flyway -url=jdbc:postgresql://${SW_DB_ENDPOINT}/sportywide -user=${SW_POSTGRES_USER} -password=${SW_POSTGRES_PASSWORD} -outOfOrder=true -mixed=true migrate
