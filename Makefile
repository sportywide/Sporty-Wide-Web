...
buildNode:
	$(eval VERSION := $(shell ./get-next-version))
...
buildWeb: buildBase
	$(eval VERSION := $(shell ./get-next-version sw-web))
...
buildApi: buildBase
	$(eval VERSION := $(shell ./get-next-version sw-api))
...
buildEmail: buildBase
	$(eval VERSION := $(shell ./get-next-version sw-email))
